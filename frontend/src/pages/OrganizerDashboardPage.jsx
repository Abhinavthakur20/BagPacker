export default function OrganizerDashboardPage() {
  ...
  const recentBookings = [
    ...
    [
      "VP",
      "Vikram Patil",
      "Ranthambore Safari Exp.",
      "04",
      "₹96,000",
      "CONFIRMED",
    ],
    ["SK", "Sana Khan", "Meghalaya Living Roots", "02", "₹34,000", "CANCELLED"],
  ];

  const statusClass = {
    CONFIRMED: "bg-[#daf7e6] text-[#0d6b3f]",
    PENDING: "bg-[#ffe9cd] text-[#9b5600]",
    CANCELLED: "bg-[#ffd7d7] text-[#a52222]",
  };
            ...
            <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-[#6f736b]">
                  Your expedition performance at a glance.
                </p>
              </div>
            ...
            <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              {metrics.map((item) => (
                ...
                >
                  ...
                  {item.label === "Avg. Fill Rate" ? (
                    <div className="mt-3 h-1.5 rounded-full bg-[#dedcd5]">
                      <div className="h-full w-[92%] rounded-full bg-[#9b5600]" />
                    </div>
                  ) : null}
                </article>
              ))}
              ...
              <article className="relative overflow-hidden rounded-3xl bg-[#194f3c] shadow-sm">
                ...
                <div className="absolute bottom-5 left-5 right-5 text-white">
                  ...
                  <h3 className="mt-2 font-headline text-3xl font-extrabold leading-tight">
                    Spiti Valley: The Star Gazing Trail
                  </h3>
                ...
                <table className="w-full min-w-[860px] text-left text-sm">
                  <thead className="text-[10px] uppercase tracking-[0.14em] text-[#7f837c]">
                    <tr>
                      ...
                      <th className="px-5 py-4">Trip Name</th>
